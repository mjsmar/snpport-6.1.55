...
printk(KERN_NOTICE "MJS-%s KVM_SEV_SNP_LAUNCH_UPDATE executed r=%d\n", __func__, r);
		break;
	case KVM_SEV_SNP_LAUNCH_FINISH:
printk(KERN_NOTICE "MJS-%s KVM_SEV_SNP_LAUNCH_FINISH executed r=%d\n", __func__, r);
